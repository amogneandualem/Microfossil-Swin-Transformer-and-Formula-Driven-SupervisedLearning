...
# --- CONFIGURATION ---
# Fixed the missing quotation mark and used the correct Repo ID format
...
def load_model_direct():
    # 1. Download only the weights file from HF
    model_path = hf_hub_download(repo_id=REPO_ID, filename=FILENAME)
    
    # 2. Build the Swin architecture
    # We use embed_dim=128 to match your '1024/2048' channel error
    ...
    # If trained with a wrapper, extract the dictionary
